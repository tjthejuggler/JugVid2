try:
    ...
    print("MediaPipe not available, using fallback skeleton detector")

import numpy as np
import cv2

if not MEDIAPIPE_AVAILABLE:
    # Import and use the fallback class
    from .skeleton_detector_fallback import SkeletonDetector
else:
